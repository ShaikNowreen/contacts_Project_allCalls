package contacts_Project.config

import contacts_Project.common.constant.SpringProfile
...
@PropertySource('file:${SPRING_BOOT_PROPERTIES_DIR}/allCalls.properties')
class SecondaryDataSourceLocalConfig extends SecondaryDataSourceAbstractConfig {
    ...
    SecondaryDataSourceLocalConfig() {
        ...
        assert Files.exists(Paths.get("${dir}/allCalls.properties")),
                "${dir}/allCalls.properties containing externalized datasource properties must exist"
    }
